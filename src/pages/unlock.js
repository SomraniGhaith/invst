  ...
  return (
    <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: (width > 650 ? 'space-between' : 'center'), alignItems: 'center' }}>
      {Object.keys(connectorsByName).map(name => {
        ...
        var display = name;
        if (name === 'MetaMask') {
          url = require('../../assets/assets/icn-metamask.svg')
        } else if (name === 'WalletConnect') {
          url = require('../../assets/assets/walletConnectIcon.svg')
        } else if (name === 'TrustWallet') {
          url = require('../../assets/assets/trustWallet.png')
        } else if (name === 'Portis') {
          url = require('../../assets/assets/portisIcon.png')
        } else if (name === 'Fortmatic') {
          url = require('../../assets/assets/fortmaticIcon.png')
        } else if (name === 'Ledger') {
          url = require('../../assets/assets/icn-ledger.svg')
        } else if (name === 'Squarelink') {
          url = require('../../assets/assets/squarelink.png')
        } else if (name === 'Trezor') {
          url = require('../../assets/assets/trezor.png')
        } else if (name === 'Torus') {
          url = require('../../assets/assets/torus.jpg')
        } else if (name === 'Authereum') {
          url = require('../../assets/assets/icn-aethereum.svg')
        } else if (name === 'WalletLink') {
          display = 'Coinbase Wallet'
          url = require('../../assets/assets//coinbaseWalletIcon.svg')
        } else if (name === 'Frame') {
          return ''
        }
